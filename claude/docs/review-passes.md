...
that runs a pass supplies the check itself and the flow around it.
...
Anything the user names at invocation overrides that default scope.

## Weighing findings {#weigh}
...
overwhelming. Stop there: reviewing and fixing is the whole job, and committing
is not part of it.
